function u = Heat1DFD_MIX_3(t,x,u,alpha2)
%
% Heat1DFD_MIX_3 numerically solves the one-dimensional heat equation,
% with Mixed boundary Conditions : u(0,t)= 0, ux(end,t) + u(end,t) = 0, 
% using the finite-difference method.
%
% u = Heat1DFD_MIX_3(t,x,u,alpha2) where
%
...
for n = 1:length(t)-1
    ...
    u(end,n+1) = (1-2*eta)*u(end,n) + 2*eta*(u(end-1,n)) - 2*hx*u(end,n);   % For j = M
end