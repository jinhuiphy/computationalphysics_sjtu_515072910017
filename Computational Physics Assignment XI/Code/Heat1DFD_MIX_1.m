function u = Heat1DFD_MIX_1(t,x,u,alpha2)
%
% Heat1DFD_MIX_1 numerically solves the one-dimensional heat equation, 
% with Mixed boundary Conditions : ux(0,t) = u(end,t) = 0 using the
% finite-difference method.
%
% u = Heat1DFD_MIX_1(t,x,u,alpha2) where
%
