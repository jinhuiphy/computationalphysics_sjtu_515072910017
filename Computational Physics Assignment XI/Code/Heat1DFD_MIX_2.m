function u = Heat1DFD_MIX_2(t,x,u,alpha2)
%
% Heat1DFD_MIX_2 numerically solves the one-dimensional heat equation,
% with Mixed boundary Conditions : u(0,t) = ux(end,t) = 0, using the
% finite-difference method.
%
% u = Heat1DFD_MIX_2(t,x,u,alpha2) where
%
